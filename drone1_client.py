...
sock.connect(('165.246.45.45', 1000))  # base center
...
def function_BaseCenter():
    ...
    while True:
        ...
        total_data = float(data1) + float(data2) + float(data3)

        sock.send(str(total_data).encode())  # 수집 센서 값을 base center에게 전송

        print("Deliver sensor1 data to base center: " + str(total_data))
...
def function_sensor1():
    ...
    try:
        ...
        sock1.connect(('165.246.45.45', 100))  # sensor1
...
def function_sensor2():
    ...
    try:
        ...
        sock2.connect(('165.246.45.45', 300))  # sensor2
...
def function_sensor3():
    ...
    try:
        ...
        sock3.connect(('165.246.45.45', 500))  # sensor3
...
# Sensor3 = threading.Thread
# (target=function_sensor3())
